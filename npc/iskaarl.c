...
void configure() {
    ...
    set_sex(Sex_Male);
    set_level(15);
    set_culture_name("Iskaarl");
    set_alignment(({ 0, 0 }));
    add_description(Description_Type_Generic);    
    add_known_description(({
      'v',    ({ "recognize", 'v' }), ({ 'o', 0 }),  "as Iskaarl, the merchant that runs Iskaarl's Oddities",
    }));
    ...
    set_chat(3, ({
        "say I've quite a collection of goods that you may find of use. to %p",
        "say We sell all sorts of items here! to %p",
        "say Stay awhile and listen! to %p",
