...
//Darron's Back Alley BBQ - map_-10_-11_0//
//House - map_-10_-10_0//
...
void configure() {
    ...
    add_known_description(({
      'v',    ({ "recognize", 'v' }), ({ 'o', 0 }),  "as Darron, the owner of his Back Alley BBQ restaurant",
    }));
    ...
    set_chat(3, ({
        "shout Back Alley BBQ! We got chicken, we got ribs, we got steak!",
        "say What do you want to order? to %p",
        "say Try the barbecue! to %p",
