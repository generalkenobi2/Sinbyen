...
void configure() {
    ...
    set_sex(Sex_Male);
    set_level(15);
    set_culture_name("Marco");
    set_title("the mayor of Sinbyen");
    set_alignment(({ 0, 0 }));
    ...
    set_chat(3, ({
        "say This is Sinbyen, beautiful is it not? to %p",
        "say I was recently elected mayor of Sinbyen, it is an honor. to %p",
