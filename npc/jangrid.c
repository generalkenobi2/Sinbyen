...
//Jangrid's Rainments - map_3_-7_0//
//House - map_4_-7_0//
...
void configure() {
    ...
    set_sex(Sex_Male);
    set_level(15);
    set_culture_name("Jangrid");
    set_alignment(({ 0, 0 }));
    add_description(Description_Type_Generic);    
    add_known_description(({
      'v',    ({ "recognize", 'v' }), ({ 'o', 0 }),  "as Jangrid, the owner of Jangrid's Rainments",
    }));
    alter_element(Material_Hair, Element_Color, "blond");
    alter_element(Material_Eye, Element_Color, "light blue");
    ...
    set_chat(3, ({
        "say We have the finest attire in all of Sinbyen. to %p",
        "say If a you were joining a king for dinner, you'd shop here to look your best. to %p",
        "say Can I help you find something that fits? to %p",
