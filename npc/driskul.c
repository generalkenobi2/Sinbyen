...
void configure() {
    ...
    set_sex(Sex_Male);
    set_level(15);
    set_culture_name("Driskul");
    set_alignment(({ 1000, 1000 }));
    add_description(Description_Type_Generic);    
    add_known_description(({
      'v',    ({ "recognize", 'v' }), ({ 'o', 0 }),  "as driskul, the local counselor for the city of Sinbyen",
    }));
    alter_element(Material_Hair, Element_Color, "red");
    ...
    set_chat(3, ({
        "say Are you feeling well? to %p",
        "say Many come to me with their troubles. to %p",
        "say If you need someone to offer advice, or just listen, I'm here for you. to %p",
